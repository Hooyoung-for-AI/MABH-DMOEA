...
function [outputPopulation,Memory_Set] = ChoseToResponse(Problem,Population,outputPopulation,i,responsePrar,Memory_Set)
    ...
    switch responseNum
        case 0
            outputPopulation = Response2(Problem,outputPopulation,i,responsePrar.kneeDirction,1);
        case 1
            MDPC = Population(responsePrar.clusterReprsentIdv);
            outputPopulation = Response5(Problem,outputPopulation,i,MDPC,responsePrar.clusterDirction,1);
        case 2
            outputPopulation = Response6(Problem,outputPopulation,i,Memory_Set); 
